...
public class MainCharacter extends RunnableObject{
	...
	private int startingHeight = 20;	//Maximum jump is calculated by the player's current height subtracted by how high he can jump.
